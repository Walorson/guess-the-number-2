...
export function printHints(random: number, customMode: boolean = false): void {
    ...
    if(random > half) features.graterThanHalf = true;
    if(random % 2 == 0) features.even = true;
    if(random % 3 == 0) features.divisibleBy3 = true;
