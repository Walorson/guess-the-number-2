export function changeColor(color: string): void
{
    ...
    {
        case "red": {
            colorPalette("217, 29, 29", "182, 23, 23", "137, 16, 16", "175, 21, 21", "137,16,16, 0.75", "255, 0, 0");
        } break;
        case "blue": {
...
function colorPalette(colorMain: string, colorTitle: string, colorBorder: string, colorShadow: string, colorShadow2: string, progressCircle: string = "red"): void
{
